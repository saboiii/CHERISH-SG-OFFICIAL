                        ...
                        <div className="md:w-[50%] h-[50%] bg-gradient-to-l from-[#ffd7e4] to-[#ffc8d5] rounded-xl overflow-y-auto">
                            <div className="h-full py-8 px-8 md:px-12">
                                <form className="mb-8" onSubmit={handleSubmit}>
                                    ...
                                    <button className=" text-[#f8e3ea] bg-rose-600 hover:bg-blue-600 transition ease-out duration-500 font-lexendbold text-sm list-none bg-gradient-to-r from-rose-400/50 to-blue-400/50 py-2 px-8 rounded">
